...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (true) {
            ...
            if (i5 < count2) {
                ...
                int weightedMaxWidth7 = count2;
                int weightedMaxWidth8 = i8;
                if (this.mTotalLength > 0) {
                    count = weightedMaxWidth7;
                ...
                if (skippedMeasure) {
                    ...
                    int alternativeMaxWidth6 = Math.max(alternativeMaxWidth5, weightedMaxWidth8);
                    if (useLargestChild != 0) {
    ...
    public void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (i5 < count2) {
            ...
            if (child == null) {
                ...
                if (child.getVisibility() == 8) {
                    ...
                    i5 = i2 + getChildrenSkipCount(child, i2);
        ...
        int i8 = weightedMaxHeight4;
        int largestChildWidth8 = alternativeMaxHeight7;
        int largestChildWidth9 = i8;
        ...
        if (skippedMeasure) {
            ...
            if (useLargestChild2 == 0 || widthMode == 1073741824) {
                ...
                int i13 = widthSize3;
                int i14 = largestChildWidth8;
            } else {
                int i15 = 0;
                while (i15 < count2) {
                    float totalWeight4 = totalWeight2;
                    View child3 = getVirtualChildAt(i15);
                    if (child3 != null) {
        ...
        while (i24 < count2) {
            ...
            if (child4 != null) {
                ...
                if (child4.getVisibility() == 8) {
                    ...
                    if (childExtra2 > 0.0f) {
                        count = count2;
                        int share = (int) ((((float) delta2) * childExtra2) / weightSum);
                    ...
                    int alternativeMaxHeight11 = Math.max(alternativeMaxHeight10, matchHeightLocally2 ? margin3 : childHeight3);
                    if (allFillParent2) {
