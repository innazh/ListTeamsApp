...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public Action build() {
                ...
                Action action = new Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, textInputsArr, dataOnlyInputsArr, this.mAllowGeneratedReplies);
                return action;
            }
        }
    ...
    public static class MessagingStyle extends Style {
        ...
        public static final class Message {
            ...
            static Message getMessageFromBundle(Bundle bundle) {
                ...
                String str4 = KEY_TIMESTAMP;
                String str5 = KEY_TEXT;
                try {
                    if (bundle.containsKey(str5)) {
                        if (bundle.containsKey(str4)) {
                            Message message = new Message(bundle.getCharSequence(str5), bundle.getLong(str4), bundle.getCharSequence(KEY_SENDER));
    ...
    static Action getActionCompatFromAction(android.app.Notification.Action action) {
        ...
        Action action2 = new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputs, null, allowGeneratedReplies);
        return action2;
    }
